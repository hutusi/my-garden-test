...
\[hutusi\](http://hutsusi.com)

[Link hello](https://hutusi.com)

[Link](https://hutusi.com)

hello `worl hello` this this what **hello \`hello\`** 
...
- Default ring `width` changed from ~~3px~~ to *hello* `hello` 1px **hello** 
- Standalone opacity utilities removed — use slash syntax instead (e.g., `bg-black/50`) ~~helo~~  
