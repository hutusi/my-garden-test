...
export const siteConfig = {
  ...
  // ── Site identity ─────────────────────────────────────────────────────────
  title: { en: "hello world", zh: "hello world" },
  logo: {
  ...
  description: { en: "hello the new world", zh: "hello the new world" },
  ...
  footerText: { en: `© ${new Date().getFullYear()} hello world. All rights reserved.`, zh: `© ${new Date().getFullYear()} hello world. 保留所有权利。` },
